%% @doc update_customer_profile_handler

-module(update_customer_profile_handler).
...
init(Req0, Opts) ->
    ...
    #{num_rows := N} = 
	db_helpers:update_customer_profile(
		FireBaseUid, AddressLine1, AddressLine2, City, State, Pincode, Latitude, Longitude, round(GeoAccuracy), CustomerName ),
